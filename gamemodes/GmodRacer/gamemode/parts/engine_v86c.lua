Part.Name = "8 Cylinder 4 Stroke Engine";
Part.Class = "Engine";
Part.ClassLevel = 2;
Part.Cost = 15000;
...
// Engine Details
Part.AddedWeight = 500; // Weight of the part.
Part.AddedHorsepower = 0; // Acceleration
Part.AddedForwardMaximumMPH = 20; // Maximum forward MPH
Part.AddedReverseMaximumMPH = 10; // Maximum reverse MPH
...
// Sterring Details
Part.AddedTurningDegrees_Slow = -20; // steering cone at zero to slow speed
Part.AddedTurningDegrees_Fast = -10; // steering cone at fast speed to max speed
