...
Part.Cost = 20000;
Part.Icon = "spoiler";
Part.Description = "Helps keep you on the ground.";
Part.Sellable = true;
Part.RequiredModels = {"models/carparts/spoiler3.mdl"}
...
function Part.Place ( Jeep, Forward, Back, Right, Left, Up, Down )
	...
	Entity:SetPos(Jeep:GetPos() + (Back * 80) + Vector(0, 0, 92))
	Entity:SetAngles(Jeep:GetAngles() + Angle(75, -90, 90));
	Entity:SetModel("models/carparts/spoiler3.mdl");
