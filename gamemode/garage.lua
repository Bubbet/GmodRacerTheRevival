function GM:DrawGarage ( )
	GAMEMODE.GarageVehicle:SetAngles(GAMEMODE.GarageVehicle:GetAngles() + Angle(0, 1, 0));
		...
		if !self.FontsAreSetup_GM then
			...
			surface.CreateFont( "Tahoma", LeftPerPlace / 6, 1000, true, false, "ScoreboardText_Left" )
			surface.CreateFont( "Tahoma", RightPerPlace / 6, 1000, true, false, "ScoreboardText_Right" )
		end
