Part.Name = "Hardened Steel Vehicle Body";
Part.Class = "Chasis";
Part.ClassLevel = 2;
Part.Cost = 20000;
Part.Icon = "body_3";
...
function Part.Place ( Jeep, Forward, Back, Right, Left, Up, Down )
	if Jeep:GetOwner() and Jeep:GetOwner():IsValid() and Jeep:GetOwner():GetLevel() < 5 then return {}; end
	
	Jeep:SetMaterial("buggy_reskins/body_steel");
