Part.Name = "Flaming Fag ( VIP ONLY )";
Part.Class = "VIPSkin";
Part.ClassLevel = 2;
Part.Cost = 0;
Part.Icon = "vip";
Part.Description = "A car that's flaming.";
Part.Sellable = true;
Part.RequiredModels = {}
...
function Part.Place ( Jeep, Forward, Back, Right, Left, Up, Down )
	if Jeep:GetOwner() and Jeep:GetOwner():IsValid() and Jeep:GetOwner():GetLevel() != 4 then return {}; end

	Jeep:SetMaterial("buggy_reskins/vip_flaming_fag");
