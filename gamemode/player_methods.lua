...
function PlayerMetaTable:SpawnJeep ( Location, Angles )
	...
	if !file.IsDir("../scripts/vehicles") then
		rawio.mkdir(".\\garrysmod\\scripts\\vehicles");
	end
	...
	rawio.writefile(".\\garrysmod\\scripts\\vehicles\\gmracer_" .. GAMEMODE.NumJeepsPlaced .. ".txt", SaveFile);
	...
	rawio.deletefile(".\\garrysmod\\scripts\\vehicles\\gmracer_" .. GAMEMODE.NumJeepsPlaced .. ".txt");
